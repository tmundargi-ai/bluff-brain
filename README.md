...
🎮 **[Play it live →](#)** *(add your deployed URL here)*
...
git clone https://github.com/YOUR_USERNAME/bluff-brain.git
cd bluff-brain
...
├── bluff-brain.jsx       # Main game component
...
This project was built for the **OpenAI x Handshake Codex Creator Challenge** (March 24 – April 30, 2026).
